using DeckHistoryPlugin.Api.Web;
...
namespace DeckHistoryPlugin.Api
{
    internal class WebClient
    {
        ...
        public async Task<HttpWebResponse> PutJsonAsync(string url, string data, bool gzip, params Header[] headers)
            => await SendWebRequestAsync(CreateRequest(url, Put, ContentType.Json), data, gzip, headers);
